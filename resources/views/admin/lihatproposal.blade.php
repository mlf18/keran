                            ...
                            <div class="tab-content" id="myTabContent">    
                                    ...
                                    {{--  <form method="POST" action="{{url('/proposals')}}">
                                        ...
                                        <div class="tab-content" id="nav-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="nav-kelompok" role="tabpanel" aria-labelledby="nav-kelompok-tab">
                                                ...
                                                <div class="form-group">
                                                    <label for="temuan_baru_kelompok">Temuan Baru</label>
                                                    <input type="text" class="form-control" id="temuan_baru_kelompok" name="temuan_baru_kelompok" value="{{isset($inventor->temuan)?$inventor->temuan:''}}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="pengembangan_dari_kelompok">Pengembangan dari</label>
                                ...
                                <div class="tab-pane fade" id="kuesioner" role="tabpanel" aria-labelledby="kuesioner-tab">
                                    {{--  <form>  --}}
                                        ...
                                        <a href="#" class="btn btn-secondary" id="lanjutkan_kuesioner">Lanjutkan</a> 
                                    {{--  </form>  --}}
                                </div>
                                <div class="tab-pane fade" id="proposal" role="tabpanel" aria-labelledby="proposal-tab">
                                    ...
                                    {{--  <form>  --}}
                                        ...
                                        <div class="form-group">
                                            <label for="proposal_file_1">Foto Produk <br><small>File pdf/jpg, maksimal 1 mb</small></label><br>
                                        ...
                                        <div class="form-group">
                                            <label for="proposal_surat">Surat Pernyataan Keaslian Temuan <br><small>File pdf/jpg, maksimal 1 mb</small></label><br>
                                        ...
                                        <div class="form-group">
                                            <label for="proposal_pendukung">Data Dukung Kelengkapan Proposal atau Profil Temuan/Inovasi <small>(Contoh : Uji Lab, Sertifikasi, Legalitas Usaha, Berita media cetak/elektronik dan lain-lain)</small><br><small>File pdf, maksimal 10 mb</small></label><br>
                                        ...
                                        <div class="form-group">
                                            @if($proposal->lampiran4_name!='')<label><a href="{{url('file/'.$proposal->lampiran4_name)}}" target="_blank"></a>Data pendukung 4</label><br/>@endif
                                            <input type="file" class="form-control-file" id="proposal_daftar_riwayat_3" name="proposal_daftar_riwayat_3">
                                        </div>
                                        <div class="form-group">
                                            @if($proposal->lampiran5_name!='')<label><a href="{{url('file/'.$proposal->lampiran5_name)}}" target="_blank"></a>Data pendukung 5</label><br/>@endif
                                        ...
                                        <button type="submit" value="" name="" class="btn btn-default" disabled>Cetak</button> <button tyoe="submit" class="btn btn-primary" name='submit' value='edit'>Edit</button> <button tyoe="submit" class="btn btn-success" name='submit' value='approve'>Approve</button> 
                                    {{--  </form>  --}}
                                </div>
                            </div>
                        </form>
